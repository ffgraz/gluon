...
bridge_rule('FORWARD', 'obrname "br-client" iifname "bat0" oifname "local-port" drop')
bridge_rule('FORWARD', 'obrname "br-client" iifname "local-port" oifname "bat0" drop')

bridge_rule('PREROUTING', 'ibrname "br-client" iifname "bat0" ether saddr ' .. macaddr .. ' drop')
bridge_rule('PREROUTING', 'ibrname "br-client" iifname "bat0" ether daddr ' .. macaddr .. ' drop')
...
if next_node.ip4 then
	...
	bridge_rule('FORWARD', 'obrname "br-client" iifname "bat0" arp daddr ip ' .. next_node.ip4 .. ' drop')
