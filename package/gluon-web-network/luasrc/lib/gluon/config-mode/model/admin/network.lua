...
local s_actions = f_actions:section(Section)

local action = s_actions:option(ListValue, "action", translate("Action"))
...
local interface = s_actions:option(ListValue, "interface", translate("Interface"))
...
local vlan_id = s_actions:option(Value, "vlan_id", translate("VLAN ID"))
...
local vlan_iface_to_delete = s_actions:option(ListValue, "vlan_iface_to_delete", translate("VLAN Interface"))
